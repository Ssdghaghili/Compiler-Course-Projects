// Generated from C:/Users/Amirali/Desktop/faz2/src/main/grammar/UTL.g4 by ANTLR 4.13.1
package parsers;
...
public class UTLParser extends Parser {
	...
	public final FunctionDeclarationContext functionDeclaration() throws RecognitionException {
		...
		try {
			...
			Identifier temp = new Identifier((((FunctionDeclarationContext)_localctx).ID!=null?((FunctionDeclarationContext)_localctx).ID.getText():null)); _localctx.funcDecRet.setName(temp); _localctx.funcDecRet.setLine((((FunctionDeclarationContext)_localctx).ID!=null?((FunctionDeclarationContext)_localctx).ID.getLine():0)); 
			setState(131);
			match(LPAREN);
			setState(155);
			_errHandler.sync(this);
	...
	public final ReturnStatementContext returnStatement() throws RecognitionException {
		...
		try {
			...
			setState(215);
			match(SEMICOLON);
			 ((ReturnStatementContext)_localctx).returnStmtRet =  new ReturnStmt(((ReturnStatementContext)_localctx).expr.expressionRet); _localctx.returnStmtRet.setLine((((ReturnStatementContext)_localctx).RETURN!=null?((ReturnStatementContext)_localctx).RETURN.getLine():0)); 
			}
		}
		catch (RecognitionException re) {
			_localctx.exception = re;
			...
			case LBRACE:
				...
				while ((((_la) & ~0x3f) == 0 && ((1L << _la) & 574484658285715520L) != 0) || ((((_la - 70)) & ~0x3f) == 0 && ((1L << (_la - 70)) & 16383L) != 0)) {
					...
					((TryCatchStatementContext)_localctx).statement = statement();
					  ((TryCatchStatementContext)_localctx).tryCatchStmtRet =  new TryCatchStmt(null); _localctx.tryCatchStmtRet.addThenStatement(((TryCatchStatementContext)_localctx).statement.statementRet); 
					}
					}
					setState(227);
					_errHandler.sync(this);
	...
	public final InitDeclarationContext initDeclaration() throws RecognitionException {
		...
		try {
			...
			Identifier id = new Identifier((((InitDeclarationContext)_localctx).ID!=null?((InitDeclarationContext)_localctx).ID.getText():null));id.setLine((((InitDeclarationContext)_localctx).ID!=null?((InitDeclarationContext)_localctx).ID.getLine():0));_localctx.initDecRet.setTradeName(id);
			setState(283);
			match(RPAREN);
			setState(286);
			_errHandler.sync(this);
	...
	public final MethodCallContext methodCall() throws RecognitionException {
		...
		try {
			...
			((MethodCallContext)_localctx).temp =  false;
			setState(418);
			_errHandler.sync(this);
			_la = _input.LA(1);
			if (_la==LBRACK) {
		...
		try {
			...
			case 2:
				...
				case NOT:
					...
					((ExpressionContext)_localctx).op1 =  UnaryOperator.NOT; ((ExpressionContext)_localctx).Line =  (((ExpressionContext)_localctx).NOT!=null?((ExpressionContext)_localctx).NOT.getLine():0);
					}
					break;
				case MINUS:
					{
			...
			case 4:
				...
				setState(470);
				match(RPAREN);
				 ((ExpressionContext)_localctx).expressionRet =  ((ExpressionContext)_localctx).lexpr.expressionRet; 
				}
				break;
			case 5:
				{
			...
			case 6:
				...
				((ExpressionContext)_localctx).methodCall = methodCall();
				 ((ExpressionContext)_localctx).expressionRet =  ((ExpressionContext)_localctx).methodCall.methCallRet; 
				}
				break;
			}
				...
				if ( _alt==1 ) {
					...
					case 1:
						...
						case MULT:
							...
							((ExpressionContext)_localctx).op2 =  BinaryOperator.MULT; ((ExpressionContext)_localctx).Line =  (((ExpressionContext)_localctx).MULT!=null?((ExpressionContext)_localctx).MULT.getLine():0);
							}
							break;
						case DIV:
							{
					...
					case 2:
						...
						case PLUS:
							...
							((ExpressionContext)_localctx).op2 =  BinaryOperator.PLUS; ((ExpressionContext)_localctx).Line =  (((ExpressionContext)_localctx).PLUS!=null?((ExpressionContext)_localctx).PLUS.getLine():0);
							}
							break;
						case MINUS:
							{
					...
					case 3:
						...
						case L_SHIFT:
							...
							((ExpressionContext)_localctx).op2 =  BinaryOperator.L_SHIFT; ((ExpressionContext)_localctx).Line =  (((ExpressionContext)_localctx).L_SHIFT!=null?((ExpressionContext)_localctx).L_SHIFT.getLine():0);
							}
							break;
						case R_SHIFT:
							{
					...
					case 4:
						...
						case LT:
							...
							((ExpressionContext)_localctx).op2 =  BinaryOperator.LT; ((ExpressionContext)_localctx).Line =  (((ExpressionContext)_localctx).LT!=null?((ExpressionContext)_localctx).LT.getLine():0);
							}
							break;
						case GT:
							{
					...
					case 5:
						...
						case EQ:
							...
							((ExpressionContext)_localctx).op2 =  BinaryOperator.EQ; ((ExpressionContext)_localctx).Line =  (((ExpressionContext)_localctx).EQ!=null?((ExpressionContext)_localctx).EQ.getLine():0);
							}
							break;
						case NEQ:
							{
					...
					case 6:
						...
						case BIT_AND:
							...
							((ExpressionContext)_localctx).op2 =  BinaryOperator.BIT_AND; ((ExpressionContext)_localctx).Line =  (((ExpressionContext)_localctx).BIT_AND!=null?((ExpressionContext)_localctx).BIT_AND.getLine():0);
							}
							break;
						case BIT_OR:
							{
					...
					case 7:
						...
						((ExpressionContext)_localctx).op2 =  BinaryOperator.AND; ((ExpressionContext)_localctx).Line =  (((ExpressionContext)_localctx).AND!=null?((ExpressionContext)_localctx).AND.getLine():0);
						setState(548);
					...
					case 8:
						...
						((ExpressionContext)_localctx).op2 =  BinaryOperator.OR; ((ExpressionContext)_localctx).Line =  (((ExpressionContext)_localctx).OR!=null?((ExpressionContext)_localctx).OR.getLine():0);
						setState(554);
					...
					case 9:
						...
						((ExpressionContext)_localctx).espetialVariable = espetialVariable();
						 ((ExpressionContext)_localctx).expressionRet =  new MethodCall(((ExpressionContext)_localctx).lexpr.expressionRet, ((ExpressionContext)_localctx).espetialVariable.espetialVariableRet); 
						}
						break;
					case 10:
						{
	...
	public final EspetialFunctionContext espetialFunction() throws RecognitionException {
		...
		try {
			...
			case REFRESH_RATE:
				...
				((EspetialFunctionContext)_localctx).espetialFunctionRet =  new Identifier((((EspetialFunctionContext)_localctx).REFRESH_RATE!=null?((EspetialFunctionContext)_localctx).REFRESH_RATE.getText():null)); _localctx.espetialFunctionRet.setLine((((EspetialFunctionContext)_localctx).REFRESH_RATE!=null?((EspetialFunctionContext)_localctx).REFRESH_RATE.getLine():0));
				}
				break;
			case CONNECT:
				{
	...
	public final EspetialVariableContext espetialVariable() throws RecognitionException {
		...
		try {
			...
			case ASK:
				...
				((EspetialVariableContext)_localctx).espetialVariableRet =  new Identifier((((EspetialVariableContext)_localctx).ASK!=null?((EspetialVariableContext)_localctx).ASK.getText():null)); _localctx.espetialVariableRet.setLine((((EspetialVariableContext)_localctx).ASK!=null?((EspetialVariableContext)_localctx).ASK.getLine():0));
				}
				break;
			case BID:
				{
	...
	public final EspetialMethodContext espetialMethod() throws RecognitionException {
		...
		try {
			...
			case OPEN:
				...
				((EspetialMethodContext)_localctx).espetialMethodRet =  new Identifier((((EspetialMethodContext)_localctx).OPEN!=null?((EspetialMethodContext)_localctx).OPEN.getText():null)); _localctx.espetialMethodRet.setLine((((EspetialMethodContext)_localctx).OPEN!=null?((EspetialMethodContext)_localctx).OPEN.getLine():0));
				}
				break;
			case CLOSE:
				{
	...
	public static final String _serializedATN =
		...
		"\u0001\f\u0001\f\u0001\f\u0001\f\u0003\f\u015c\b\f\u0001\f\u0001\f\u0001"+
		"\f\u0001\f\u0001\f\u0005\f\u0163\b\f\n\f\f\f\u0166\t\f\u0001\f\u0001\f"+
		"\u0001\f\u0001\f\u0003\f\u016c\b\f\u0003\f\u016e\b\f\u0001\r\u0001\r\u0001"+
		"\r\u0001\r\u0001\r\u0001\r\u0001\r\u0001\r\u0001\r\u0005\r\u0179\b\r\n"+
		"\r\f\r\u017c\t\r\u0001\r\u0001\r\u0001\r\u0001\r\u0003\r\u0182\b\r\u0001"+
		"\u000e\u0001\u000e\u0001\u000e\u0001\u000e\u0001\u000e\u0001\u000f\u0001"+
		"\u000f\u0001\u000f\u0001\u000f\u0003\u000f\u018d\b\u000f\u0001\u000f\u0001"+
		"\u000f\u0001\u000f\u0001\u000f\u0005\u000f\u0193\b\u000f\n\u000f\f\u000f"+
		"\u0196\t\u000f\u0003\u000f\u0198\b\u000f\u0001\u000f\u0001\u000f\u0001"+
